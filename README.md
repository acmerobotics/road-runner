...
1. Add `implementation 'com.acmerobotics.roadrunner:core:0.4.1'` to the end of the `dependencies` block.
...
The documentation for all releases are available online in the [KDoc format](https://acmerobotics.github.io/road-runner/core/0.4.1/kdoc/) (more accurately reflects the Kotlin source) and in the more traditional [Javadoc format](https://acmerobotics.github.io/road-runner/core/0.4.1/javadoc/).
