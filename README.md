...
1. At the bottom of the file, add a `repositories` block with `jcenter()`. Next add a `dependencies` block with `implementation 'com.acmerobotics.roadrunner:core:0.2.2'`. After you're finished, your `build.gradle` should look like this:
    ...
    dependencies {
        // other dependencies
        implementation 'com.acmerobotics.roadrunner:core:0.2.2'
    }
    ```
...
The documentation for all releases are available online in the [KDoc format](https://acmerobotics.github.io/road-runner/core/0.2.2/kdoc/) (more accurately reflects the Kotlin source) and in the more traditional [Javadoc format](https://acmerobotics.github.io/road-runner/core/0.2.2/javadoc/).
